...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.githubRepoUrl': '顶部 GitHub 仓库地址',
        'config.advanced.githubRepoUrlPlaceholder': '例如: https://github.com/your-org/your-repo',
        'config.advanced.githubRepoUrlNote': '用于顶部 GitHub 按钮跳转，仅支持 http/https 链接',
        'config.advanced.githubRepoUrlInvalid': 'GitHub 仓库地址无效，请输入 http/https 链接',
        ...
        'providers.deleteGroup': '删除分组',
        'providers.deleteGroup.title': '删除分组',
        'providers.deleteGroup.confirm': '确定删除分组 {providerType} 吗？',
        'providers.deleteGroup.confirmWithCount': '确定删除分组 {providerType} 吗？该分组下共有 {count} 个供应商节点。',
        'providers.deleteGroup.warningWithCount': '删除后将一并移除该分组下所有节点，且不可恢复。',
        'providers.deleteGroup.warningEmpty': '该分组当前无节点，删除后不可恢复。',
        'providers.deleteGroup.confirmButton': '确认删除',
        'providers.deleteGroup.success': '分组删除成功',
        'providers.deleteGroup.error': '分组删除失败',
        ...
        'providers.currentRoute.label': '当前使用',
        'providers.currentRoute.none': '暂无请求',
        'providers.currentRoute.provider': '供应商',
        'providers.currentRoute.model': '模型',
        ...
        'modal.provider.modelMappingTitle': '\u6a21\u578b\u6620\u5c04',
        'modal.provider.modelMappingCount': '\u6620\u5c04 {count} \u6761',
        'modal.provider.modelMappingEmpty': '\u6682\u65e0\u6a21\u578b\u6620\u5c04\u3002',
        'modal.provider.modelPickerManualModelsTitle': '\u624b\u52a8\u8f93\u5165\u53ef\u7528\u6a21\u578b',
        'modal.provider.modelPickerManualModelsPlaceholder': '\u652f\u6301\u6309\u884c\u6216\u9017\u53f7\u5206\u9694\n\u4f8b\u5982:\ngpt-4.1\ngpt-4o-mini',
        'modal.provider.modelPickerManualModelsHelp': '\u624b\u52a8\u8f93\u5165\u7684\u6a21\u578b\u4f1a\u5728\u786e\u8ba4\u65f6\u5408\u5e76\u5230\u5df2\u9009\u6a21\u578b\u5217\u8868\u3002',
        'modal.provider.modelPickerManualMappingTitle': '\u624b\u52a8\u8f93\u5165\u6a21\u578b\u6620\u5c04',
        'modal.provider.modelPickerManualMappingPlaceholder': '\u6bcf\u884c\u4e00\u6761\uff1a\u8bf7\u6c42\u6a21\u578b => \u5b9e\u9645\u6a21\u578b\n\u4f8b\u5982:\ngpt-4o => gpt-4.1\n\u6216\u76f4\u63a5\u8f93\u5165 JSON \u5bf9\u8c61',
        'modal.provider.modelPickerManualMappingHelp': '\u652f\u6301 => / -> / = \u6216 JSON \u683c\u5f0f\uff0c\u53d1\u9001\u65f6\u4f1a\u81ea\u52a8\u8f6c\u6362\u5230\u76ee\u6807\u6a21\u578b\u3002',
        'modal.provider.modelPickerMappingPreviewEmpty': '\u5f53\u524d\u672a\u914d\u7f6e\u6a21\u578b\u6620\u5c04',
        'modal.provider.modelPickerMappingPreviewValid': '\u6620\u5c04\u6821\u9a8c\u901a\u8fc7\uff0c\u5171 {count} \u6761',
        'modal.provider.modelPickerMappingPreviewInvalid': '\u6620\u5c04\u683c\u5f0f\u9519\u8bef',
        'modal.provider.modelMappingInvalidJson': '\u6a21\u578b\u6620\u5c04 JSON \u683c\u5f0f\u65e0\u6548',
        'modal.provider.modelMappingInvalidLine': '\u6a21\u578b\u6620\u5c04\u7b2c {line} \u884c\u683c\u5f0f\u65e0\u6548\uff0c\u8bf7\u4f7f\u7528 key => value',
        'modal.provider.addTitle': '添加新提供商配置',
        'modal.provider.customName': '自定义名称',
        'modal.provider.remark': '备注信息',
        'modal.provider.remarkPlaceholder': '例如: 海外节点 / 备用节点',
        ...
        'modal.provider.disableAll': '一键禁用',
        'modal.provider.disableAllBtn': '一键禁用',
        'modal.provider.disableAllConfirm': '确定要禁用当前分组中 {count} 个可用节点吗？仅影响当前分组，不影响子分组。',
        'modal.provider.disableAll.noProviders': '当前分组没有可禁用节点',
        'modal.provider.disableAll.disabling': '正在禁用...',
        'modal.provider.disableAll.success': '已禁用 {count} 个节点',
        'modal.provider.disableAll.failed': '一键禁用失败',
        'modal.provider.healthCheck.complete': '健康检查完成: {success} 变为健康',
        'modal.provider.healthCheck.abnormal': ', {fail} 异常',
        'modal.provider.healthCheck.skipped': ', 其中 {skipped} 条告警按不健康处理',
        'modal.provider.healthCheck.skippedDisabled': '（禁用导致无法检测: {count}）',
        'modal.provider.healthCheck.skippedCheckHealth': '（checkHealth关闭导致无法检测: {count}）',
        'modal.provider.healthCheck.skippedOther': '（其他异常导致无法检测: {count}）',
        'modal.provider.healthCheck.reportTitle': '{type} 健康检测明细',
        'modal.provider.healthCheck.reportSummary': '成功 {success}，不健康 {fail}',
        'modal.provider.healthCheck.reportNoResults': '暂无检测明细',
        'modal.provider.healthCheck.reportModel': '检测模型',
        'modal.provider.healthCheck.reportReason': '异常原因',
        'modal.provider.healthCheck.reportMessage': '结果信息',
        'modal.provider.healthCheck.status.healthy': '健康',
        'modal.provider.healthCheck.status.failed': '失败',
        'modal.provider.healthCheck.status.skipped': '告警(按不健康处理)',
        'modal.provider.healthCheck.reason.disabled': '节点已禁用',
        'modal.provider.healthCheck.reason.checkHealthDisabled': 'checkHealth 未启用',
        'modal.provider.healthCheck.reason.other': '其他',
        ...
        'modal.provider.healthCheckSingleWarning': '健康检查告警: {message}',
        'modal.provider.healthCheckSingleWarningDisabled': '健康检查告警: 节点已禁用，已按不健康处理',
        'modal.provider.healthCheckSingleWarningCheckHealthDisabled': '健康检查告警: checkHealth 已关闭，已按不健康处理',
        ...
        'tutorial.fallback.nodeMapping.title': '节点级模型映射（检测弹窗手动配置）',
        'tutorial.fallback.nodeMapping.desc': '对于 openai-custom / openaiResponses-custom / claude-custom 节点，可在“检测可用模型”弹窗中手动维护可用模型和 modelMapping，保存后会写入 provider_pools.json：',
    ...
    'en-US': {
        ...
        'config.advanced.githubRepoUrl': 'Top GitHub Repository URL',
        'config.advanced.githubRepoUrlPlaceholder': 'Example: https://github.com/your-org/your-repo',
        'config.advanced.githubRepoUrlNote': 'Used for the top GitHub button; only http/https links are supported',
        'config.advanced.githubRepoUrlInvalid': 'Invalid GitHub repository URL. Please enter a valid http/https link',
        ...
        'providers.deleteGroup': 'Delete Group',
        'providers.deleteGroup.title': 'Delete Group',
        'providers.deleteGroup.confirm': 'Are you sure you want to delete group {providerType}?',
        'providers.deleteGroup.confirmWithCount': 'Are you sure you want to delete group {providerType}? This group has {count} provider nodes.',
        'providers.deleteGroup.warningWithCount': 'All nodes in this group will be removed and cannot be recovered.',
        'providers.deleteGroup.warningEmpty': 'This group is empty and deletion cannot be undone.',
        'providers.deleteGroup.confirmButton': 'Confirm Delete',
        'providers.deleteGroup.success': 'Group deleted successfully',
        'providers.deleteGroup.error': 'Failed to delete group',
        ...
        'providers.currentRoute.label': 'Current',
        'providers.currentRoute.none': 'No recent request',
        'providers.currentRoute.provider': 'Provider',
        'providers.currentRoute.model': 'Model',
        ...
        'modal.provider.modelMappingTitle': 'Model Mapping',
        'modal.provider.modelMappingCount': '{count} mappings',
        'modal.provider.modelMappingEmpty': 'No model mappings configured yet.',
        'modal.provider.modelPickerManualModelsTitle': 'Manual Available Models',
        'modal.provider.modelPickerManualModelsPlaceholder': 'Split by newline or comma\nExample:\ngpt-4.1\ngpt-4o-mini',
        'modal.provider.modelPickerManualModelsHelp': 'Manual models will be merged into selected models when confirmed.',
        'modal.provider.modelPickerManualMappingTitle': 'Manual Model Mapping',
        'modal.provider.modelPickerManualMappingPlaceholder': 'One mapping per line: requested => actual\nExample:\ngpt-4o => gpt-4.1\nOr provide a JSON object directly',
        'modal.provider.modelPickerManualMappingHelp': 'Supports => / -> / = or JSON. Requests will be remapped automatically.',
        'modal.provider.modelPickerMappingPreviewEmpty': 'No model mapping configured currently',
        'modal.provider.modelPickerMappingPreviewValid': 'Mapping validation passed, {count} entries',
        'modal.provider.modelPickerMappingPreviewInvalid': 'Invalid mapping format',
        'modal.provider.modelMappingInvalidJson': 'Invalid model mapping JSON format',
        'modal.provider.modelMappingInvalidLine': 'Invalid mapping at line {line}. Use key => value',
        'modal.provider.addTitle': 'Add New Provider Config',
        'modal.provider.customName': 'Custom Name',
        'modal.provider.remark': 'Remark',
        'modal.provider.remarkPlaceholder': 'e.g.: Overseas node / Backup node',
        ...
        'modal.provider.disableAll': 'Disable all in group',
        'modal.provider.disableAllBtn': 'Disable All',
        'modal.provider.disableAllConfirm': 'Disable {count} enabled node(s) in this group? This only affects the current group, not child groups.',
        'modal.provider.disableAll.noProviders': 'No enabled nodes in this group',
        'modal.provider.disableAll.disabling': 'Disabling...',
        'modal.provider.disableAll.success': 'Disabled {count} node(s)',
        'modal.provider.disableAll.failed': 'Disable all failed',
        ...
        'modal.provider.healthCheck.skipped': ', including {skipped} warnings treated as unhealthy',
        'modal.provider.healthCheck.skippedDisabled': ' (cannot check: disabled {count})',
        'modal.provider.healthCheck.skippedCheckHealth': ' (cannot check: checkHealth off {count})',
        'modal.provider.healthCheck.skippedOther': ' (cannot check: other {count})',
        'modal.provider.healthCheck.reportTitle': '{type} Health Check Details',
        'modal.provider.healthCheck.reportSummary': '{success} healthy, {fail} unhealthy',
        'modal.provider.healthCheck.reportNoResults': 'No health check details',
        'modal.provider.healthCheck.reportModel': 'Model',
        'modal.provider.healthCheck.reportReason': 'Reason',
        'modal.provider.healthCheck.reportMessage': 'Message',
        'modal.provider.healthCheck.status.healthy': 'Healthy',
        'modal.provider.healthCheck.status.failed': 'Failed',
        'modal.provider.healthCheck.status.skipped': 'Warning (unhealthy)',
        'modal.provider.healthCheck.reason.disabled': 'Provider disabled',
        'modal.provider.healthCheck.reason.checkHealthDisabled': 'checkHealth disabled',
        'modal.provider.healthCheck.reason.other': 'Other',
        ...
        'modal.provider.healthCheckSingleWarning': 'Health check warning: {message}',
        'modal.provider.healthCheckSingleWarningDisabled': 'Health check warning: node is disabled and treated as unhealthy',
        'modal.provider.healthCheckSingleWarningCheckHealthDisabled': 'Health check warning: checkHealth is disabled and treated as unhealthy',
        ...
        'tutorial.fallback.nodeMapping.title': 'Node-level Model Mapping (Manual in Detect Modal)',
        'tutorial.fallback.nodeMapping.desc': 'For openai-custom / openaiResponses-custom / claude-custom nodes, you can manually maintain available models and modelMapping in the "Detect Available Models" modal. It will be saved to provider_pools.json:',
