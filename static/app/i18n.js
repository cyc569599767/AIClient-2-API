...
const translations = {
    'zh-CN': {
        ...
        'modal.provider.healthCheck.skipped': ', {skipped} 跳过',
        'modal.provider.healthCheck.skippedDisabled': '（禁用: {count}）',
        'modal.provider.healthCheck.skippedCheckHealth': '（checkHealth关闭: {count}）',
        'modal.provider.healthCheck.skippedOther': '（其他: {count}）',
        'modal.provider.healthCheck.reportTitle': '{type} 健康检测明细',
        'modal.provider.healthCheck.reportSummary': '成功 {success}，失败 {fail}，跳过 {skipped}',
        'modal.provider.healthCheck.reportNoResults': '暂无检测明细',
        'modal.provider.healthCheck.reportModel': '检测模型',
        'modal.provider.healthCheck.reportReason': '跳过原因',
        ...
        'modal.provider.healthCheck.status.skipped': '跳过',
    ...
    'en-US': {
        ...
        'modal.provider.healthCheck.skipped': ', {skipped} skipped',
        'modal.provider.healthCheck.skippedDisabled': ' (disabled: {count})',
        'modal.provider.healthCheck.skippedCheckHealth': ' (checkHealth off: {count})',
        'modal.provider.healthCheck.skippedOther': ' (other: {count})',
        'modal.provider.healthCheck.reportTitle': '{type} Health Check Details',
        'modal.provider.healthCheck.reportSummary': '{success} healthy, {fail} failed, {skipped} skipped',
        'modal.provider.healthCheck.reportNoResults': 'No health check details',
        'modal.provider.healthCheck.reportModel': 'Model',
        'modal.provider.healthCheck.reportReason': 'Skip Reason',
        ...
        'modal.provider.healthCheck.status.skipped': 'Skipped',
