...
const translations = {
    'zh-CN': {
        ...
        'modal.provider.disableAllGroup': '禁用分组',
        'modal.provider.disableAllGroupBtn': '禁用分组',
        'modal.provider.disableAllGroupConfirm': '确定要禁用 {type} 分组中 {count} 个可用节点吗？',
        'modal.provider.disableAllGroup.noProviders': '当前分组没有可用节点',
        'modal.provider.disableAllGroup.disabling': '正在禁用...',
        'modal.provider.disableAllGroup.success': '已禁用 {count} 个节点',
        'modal.provider.disableAllGroup.failed': '禁用失败',
    ...
    'en-US': {
        ...
        'modal.provider.disableAllGroup': 'Disable Group',
        'modal.provider.disableAllGroupBtn': 'Disable Group',
        'modal.provider.disableAllGroupConfirm': 'Disable {count} active node(s) in group {type}?',
        'modal.provider.disableAllGroup.noProviders': 'No providers in current group',
        'modal.provider.disableAllGroup.disabling': 'Disabling...',
        'modal.provider.disableAllGroup.success': 'Disabled {count} node(s)',
        'modal.provider.disableAllGroup.failed': 'Disable failed',
